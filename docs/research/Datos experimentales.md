...
Contrastada el 2026-09-04 (fase G): la cuenta por predicción está en `results/signos.parquet` y el veredicto en [[2 - Decisiones]] de esa fecha. La predicción de la m-coherencia sobre el gap se contó como fuerte; la de la disparidad sobre el error de test, que esta tabla no registra, se reportó sin contrastar.
