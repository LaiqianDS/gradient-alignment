...
> **Nota de revisión (2026-08-01, antes de existir ningún dato de matriz).** Los criterios de H1, H3 y H4 que aparecen abajo son la redacción original de junio y quedan **superseded** por [[4 - Análisis]], que es el documento operativo. Se conservan aquí como registro de lo que se planteó, no como lo que se contrasta. Los motivos, por si se citan en la memoria:
>
