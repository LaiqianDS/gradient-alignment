...
- **Congelación del plan de análisis.** El borrador en `pending/` tiene la dependencia del tutor cerrada (2026-06-12) y el gap integrado (2026-06-14); falta el pilot de calibración para fijar presupuestos/umbrales (y el suelo de ajuste del gap) y congelarlo en `docs/`.
