...
tfg_role:
  - metric
  - baseline
tfg_note: "Origen de `gradient_disparity` (distancia L2 media entre gradientes de batches independientes; Pearson 0.957 con el error de test). Uno de los 3 papers más comparables: ellos optimizan early-stopping sin val set, el TFG sólo mide la correlación."
---
