...
**TSE-EMA** aplica una media móvil exponencial con factor $\gamma$ (los autores experimentan con $\gamma=0.9$ y $\gamma=0.999$), dando más peso a épocas tardías sin descartar las tempranas:
