...
- **Aviso metodológico sobre MNIST.** Los autores afirman explícitamente que el éxito de SVRG en MNIST no se extiende a problemas reales y que esto refleja "un problema fundamental con MNIST como baseline de optimización". MNIST sí está en la matriz congelada del TFG, junto a CIFAR-10, CIFAR-100 y Tiny ImageNet, así que el aviso se usa al leer los resultados: lo que se observe solo en MNIST no debe extrapolarse a los datasets mayores.
