...
Esto es una decisión del preregistro y no solo de ejecución, por un motivo concreto: descartar métricas antes de medirlas equivale a elegir qué hipótesis se pueden contrastar según el presupuesto de cómputo en vez de según la pregunta de investigación. H1 y H3 comparan métricas entre sí, así que quedarían apoyadas en un conjunto recortado por razones ajenas a la ciencia. El coste medido en el pilot es de ~3,21x el wall-clock de un run sin instrumentar en el peor caso (fc × cifar100: 439 s de métricas frente a 199 s de train), dentro de la cota <3-4x fijada de antemano. [Enmienda 2026-08-05, ver §Historial de revisiones.] La **poda** de métricas es posterior y solo afecta a lo que la memoria destaca, nunca a lo que se contrasta.
...
**De dónde sale δ_H2 = 0,15.** El margen no viene de la tabla de Cohen sino de la pregunta de la tesis, que es si instrumentar el gradiente compensa. El coste medido es de ~3,21x el wall-clock de un run sin instrumentar en el peor caso (§Unidad de análisis), así que la métrica tiene que aportar información suficiente para justificar multiplicar por tres el presupuesto de cómputo frente a un baseline que es gratis. [Enmienda 2026-08-05, ver §Historial de revisiones.] Una parcial cross-celda por debajo de 0,15 explica menos del 2,3% de la varianza de rangos residual, y a ese precio eso es irrelevante para la decisión de cualquier practicante.
