...
- [ ] Validez de los runs: censo de los que se quedaron sin aprender, y reconciliar en código los cuatro recuentos sueltos que hay por el vault, que además están escritos con dos umbrales distintos: 133 runs con NaN, 154 clavados en el azar, 124 con la firma de `gwa/score_mean` a cero exacto y 115 de esos que acaban clavados. Detalle y trampa en [[2 - Decisiones]] del 2026-08-31.
