...
- [x] **Punto 4, solape (2026-09-02):** acotada, no descartada; para la velocidad solo las ventanas del 5 y el 10 % anticipan algo. §Solape entre la ventana y el desenlace, figuras `solape-celda`, `solape-cruces`, `solape-bandas` y `solape-mapa`.
