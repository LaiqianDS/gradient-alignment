...
Los valores registrados muestran esa estructura. Sobre las 33.600 filas de la matriz, el coseno entre pares de la misma clase tiene mediana entre $0{,}30$ y $0{,}51$ en las tres arquitecturas, y el de pares de clases distintas se queda en cero. El coseno medio sobre todos los pares queda en el suelo del ruido en la CNN y en la red \emph{fully connected}, y unas 30 veces por encima en la ResNet-18. El argumento de concentración garantiza que una desviación así es un hecho de la red y no una fluctuación del muestreo. Alcanza también a los estadísticos de extremo. Entre los $\binom{M}{2}$ pares del \emph{batch} de medición, el coseno más negativo esperable entre direcciones sin relación tiene magnitud del orden de $\sqrt{2\ln(M^2/2)/P}$, unos $0{,}03$ en la CNN pequeña y $0{,}001$ en las redes grandes. Tampoco un valor apreciable de \emph{gradient confusion} puede atribuirse, por tanto, al azar del muestreo.
