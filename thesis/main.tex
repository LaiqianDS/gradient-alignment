...
% Revisar al cerrar los capítulos pendientes (implementación, resultados, conclusiones).
...
\begin{description}
  ...
  \item[FDR] Tasa de falsos descubrimientos (\textit{false discovery rate}).
  ...
  \item[MNIST] Conjunto de datos de dígitos manuscritos (\textit{modified NIST database}).
